    ...
    <div class="container">
        <header id="header" class="d-flex row">
            ...
            <div class="col-4 col-md-3 col-lg-2 header-button">
                <button type="button" class="btn btn-outline-light" id="btn-radius"><?= get_field('button_text') ?></button>
            </div>
        </header>
        <div class="d-flex">
        ...
        <div class="d-flex block-partner">
            <div class="col-12 col-sm-12 col-md-10 col-lg-8">
                <div class="partner-row d-flex justify-content-between">
                    <img class="logo-partner grayscale" src="http://localhost/test/wp-content/uploads/2021/03/1200px-Cartoon_Network_2010_logo.svg_.png">
                    <img class="logo-partner grayscale" src="http://localhost/test/wp-content/uploads/2021/04/Logo-Booking.com_.png">
                    <img class="logo-partner grayscale" src="http://localhost/test/wp-content/uploads/2021/03/1200px-Dropbox_logo_2017.svg_.png">
                </div>

                <div class="partner-row d-flex justify-content-between">
                    <img class="logo-partner grayscale" src="http://localhost/test/wp-content/uploads/2021/03/1024px-Toshiba_logo.svg_.png">
                    <img class="logo-partner grayscale" src="http://localhost/test/wp-content/uploads/2021/04/Slack_logo_new.png">
                    <img class="logo-partner grayscale" src="http://localhost/test/wp-content/uploads/2021/04/Netflix-logo.png">
                </div>

                <div class="partner-row d-flex justify-content-between">
                    <img class="logo-partner grayscale" src="http://localhost/test/wp-content/uploads/2021/04/spotify-logo-png-7.png">
                    <img class="logo-partner grayscale" src="http://localhost/test/wp-content/uploads/2021/03/Coca-Cola-logo.png">
                    <img class="logo-partner" src="http://localhost/test/wp-content/uploads/2021/03/red-bull-logo-2-1.png">
                </div>
